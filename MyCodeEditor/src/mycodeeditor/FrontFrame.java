...
public class FrontFrame extends javax.swing.JFrame {
    ...
    //public frontFrame(MainFrame mf) {
    public FrontFrame() {
        //new runtimeSharingPanel(mf);
        //this.mf = mf;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter you name here.....");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(name.compareTo("")!=0){
            this.dispose();
            GuiWindow hud = new GuiWindow(name, "Coder");
                    hud.makeResizeable();
                    IpCollector njf1 = new IpCollector(name, hud);
                    javax.swing.JFrame dialog = hud.getJDialog();
